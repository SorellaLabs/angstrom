...
pub static PROTOCOL_FEE_CONFIG_ADDRESS: OnceLock<Address> = OnceLock::new();
pub static PROTOCOL_FEE_CONFIG_DEPLOYED_BLOCK: OnceLock<u64> = OnceLock::new();
...
impl AngstromAddressBuilder {
    ...
    pub fn with_protocol_fee_config(self, protocol_fee_config_address: Address) -> Self {
        Self { protocol_fee_config_address, ..self }
    }

    pub fn with_protocol_fee_config_deployed_block(
        self,
        protocol_fee_config_deployed_block: u64
    ) -> Self {
        Self { protocol_fee_config_deployed_block, ..self }
    }
    ...
    pub fn build(self) -> AngstromAddressConfig {
        AngstromAddressConfig {
            ...
            protocol_fee_config_address: self.protocol_fee_config_address,
            protocol_fee_config_deployed_block: self.protocol_fee_config_deployed_block,
...
impl AngstromAddressConfig {
    pub const INTERNAL_TESTNET: Self = Self {
        ...
        protocol_fee_config_address: Address::ZERO,
        protocol_fee_config_deployed_block: 0,
    ...
    pub fn init(self) {
        ...
        PROTOCOL_FEE_CONFIG_ADDRESS
            .set(self.protocol_fee_config_address)
            .unwrap();
        PROTOCOL_FEE_CONFIG_DEPLOYED_BLOCK
            .set(self.protocol_fee_config_deployed_block)
            .unwrap();
        ANGSTROM_DOMAIN
    ...
    match chain_id {
        ...
        11155111 => {
            ...
            err |= PROTOCOL_FEE_CONFIG_ADDRESS
                .set(address!("0xa58f681e8Db5f9624e03fdfAE899128BD7e3918a"))
                .is_err();
            err |= PROTOCOL_FEE_CONFIG_DEPLOYED_BLOCK.set(11676439).is_err();
            err |= ANGSTROM_DOMAIN
                .set(alloy_sol_types::eip712_domain!(
                    name: "Angstrom",
                    version: "v1",
