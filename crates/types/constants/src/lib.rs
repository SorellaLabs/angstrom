...
pub static ANGSTROM_PROTOCOL_FEE_CONFIG_ADDRESS: OnceLock<Address> = OnceLock::new();
...
impl AngstromAddressConfig {
    ...
    pub fn init(self) {
        ...
        ANGSTROM_PROTOCOL_FEE_CONFIG_ADDRESS
    ...
    match chain_id {
        ...
        1 => {
            ...
            err |= GAS_TOKEN_ADDRESS
                ...
                .is_err();
            err |= ANGSTROM_PROTOCOL_FEE_CONFIG_ADDRESS
                .set(Address::ZERO)
                .is_err();
            err |= ANGSTROM_DOMAIN
                .set(alloy_sol_types::eip712_domain!(
