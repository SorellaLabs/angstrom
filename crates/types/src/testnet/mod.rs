...
impl InitialTestnetState {
    pub fn new(angstrom_addr: Address, pool_manager_addr: Address, state: Option<Bytes>, pool_keys: Vec<PoolKey>) -> Self {
        Self { angstrom_addr, pool_manager_addr, state, pool_keys }
    }
}
