...
use op_alloy_network::{Optimism, ReceiptResponse};
...
pub struct AnvilInitializer {
    ...
    controller_v1:        ControllerV1Instance<WalletProviderRpc, Optimism>,
    angstrom:             AngstromInstance<WalletProviderRpc, Optimism>,
    pool_gate:            PoolGateInstance<WalletProviderRpc, Optimism>,
